...
$total=mysqli_query($con, " SELECT * FROM penyelenggara p;");
        ...
        <div class="container-fluid">
          ...
          <?php include("sidebar.php")?>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"style="position: relative;margin-top:-750px">
              <h1 class="page-header">daftar penyelenggara</h1>
              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $tampung['penyelenggara_id']   ?></td>
