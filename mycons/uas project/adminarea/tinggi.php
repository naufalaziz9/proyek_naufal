...
$dropdown=mysqli_query($con,"SELECT nama_artis
FROM artis_produk a,produk p,artis aa,kategori k
where a.artis_id=aa.artis_id and p.produk_id=a.produk_id and p.kategori_id=k.kategori_id
group by nama_artis;");
$total=mysqli_query($con,"SELECT nama_produk,nama_kategori,nama_artis
FROM artis_produk a,produk p,artis aa,kategori k
where a.artis_id=aa.artis_id and p.produk_id=a.produk_id and p.kategori_id=k.kategori_id;
");
...
if(isset($_GET['jenis'])){
  ...
  $total=mysqli_query($con,"SELECT nama_produk,nama_kategori,nama_artis
  FROM artis_produk a,produk p,artis aa,kategori k
  where a.artis_id=aa.artis_id and p.produk_id=a.produk_id and p.kategori_id=k.kategori_id and nama_artis='$_GET[jenis]'
  ");
}
          ...
          <div class="row">
           <?php include("sidebar.php")?>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"style="position: relative;margin-top:-750px">
              <h1 class="page-header">ARTIS dan produknya</h1>
...
<div class="btn-group" role="group" >
        ...
        <li><a href="?jenis=<?php echo $tampung['nama_artis'] ?>"><?php echo $tampung['nama_artis'] ?></a></li>
      <?php endwhile ;?>
        </ul>
      </div>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $tampung['nama_artis']   ?></td>
                    </tr>
                    <?php endwhile; ?>
                  </tbody>
                </table>
