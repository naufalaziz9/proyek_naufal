...
$total=mysqli_query($con,"SELECt a.artis_id, t.nama_artis, count(produk_id)'jumlah_tampil' FROM artis_produk a, artis t
where a.artis_id = t.artis_id
group by artis_id
order by count(produk_id) desc;");
        ...
        <div class="container-fluid">
          ...
          <?php include("sidebar.php")?>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"style="position: relative;margin-top:-750px">
              <h1 class="page-header">Artis Yang Sering Tampil</h1>
              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                    <td><?php echo $tampung['artis_id']   ?></td>
                      <td><?php echo $tampung['nama_artis']   ?></td>
                      <td><?php echo $tampung['jumlah_tampil']   ?></td>
