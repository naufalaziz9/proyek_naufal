...
$dropdown=mysqli_query($con,"SELECT genre FROM produk p where kategori_id='k4' group by genre ;");
...
from produk
where kategori_id = 'k4';");

if(isset($_GET['jexpo'])){

  $total=mysqli_query($con,"select produk_id, nama_produk, tanggal, stok, kota, jam, genre
from produk
where kategori_id = 'k4' and genre='$_GET[jexpo]';");
}elseif(isset($_GET['kota'])){

  $total=mysqli_query($con,"select produk_id, nama_produk, tanggal, stok, kota, jam, genre
from produk
where kategori_id = 'k4' and kota='$_GET[kota]';");
}
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container-fluid">
          ...
          <?php include("sidebar.php")?>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"style="position: relative;margin-top:-700px;">
              <h1 class="page-header">Produk Kategori Expo</h1>
        ...
        <?php endwhile ;?>
              ...
              <div class="btn-group" role="group" >
                      ...
                      <?php while ($tampung=mysqli_fetch_assoc($dropdown)): ?>
                        <li><a href="expo.php?jexpo=<?php echo $tampung['genre'] ?>"><?php echo $tampung['genre'] ?></a></li>
                      <?php endwhile ;?>
                      </ul>
                    </div>
