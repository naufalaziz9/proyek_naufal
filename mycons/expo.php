...
$total=mysqli_query($con,"select * from produk where  kategori_id='k4'");
$total2=mysqli_num_rows($total);
$halaman=ceil($total2/$jumlahdataperhalaman);
if(isset($_GET['page'])){
$halamanaktif=$_GET['page'];
}else{
    $halamanaktif=1;
}
// perhalaman2 aku di page 3 awalnya 4
// perhalaman2 aku di page 4 awalnya 6
...
if( isset($_GET["jenis"])){
    ...
    from (select *from produk where kategori_id='k4') a,kursi b
...
_________________________________________________________ -->
    ...
    <footer id="footer" class="col-md-12" style="margin-top: 500px;">
        <div class="container">
    ...
    <script src="scriptexpo.js"></script>
</body>
