...
$total=mysqli_query($con,"SELect p.pembayaran_id, j.nama_pembayaran, s.`status`
FROM pembayaran p, `status`s, jenis_pembayaran j
where s.status_id = 's4'  and s.status_id = p.status_id and j.jenis_pembayaran_id = p.jenis_pembayaran_id;
");
              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                    <td><?php echo $tampung['pembayaran_id']   ?></td>
