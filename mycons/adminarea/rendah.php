...
$total=mysqli_query($con,"SELECT user_id,email,nama_depan,subyek,pesan FROM contact c;");
              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <td><?php echo $tampung['nama_depan']   ?></td>
                    <td><?php echo $tampung['subyek']   ?></td>
                    <td><?php echo $tampung['pesan']   ?></td>
