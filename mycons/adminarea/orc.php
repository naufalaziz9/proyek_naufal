...
$dropdown=mysqli_query($con,"SELECT genre FROM produk p where kategori_id='k3' group by genre ;");
...
from produk
where kategori_id='k3';");

if(isset($_GET['jorc'])){

  $total=mysqli_query($con,"select produk_id, nama_produk, tanggal, stok, kota, jam, genre
from produk
where kategori_id='k3' and genre='$_GET[jorc]';");


}elseif(isset($_GET['kota'])){
  $total=mysqli_query($con,"select produk_id, nama_produk, tanggal, stok, kota, jam, genre
  from produk
  where kategori_id='k3' and kota='$_GET[kota]';");
}
...
<html>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container-fluid">
          ...
          <?php include("sidebar.php")?>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"style="position: relative;margin-top:-750px">
              <h1 class="page-header">Produk Kategori Orchestra</h1>
        ...
        <?php endwhile ;?>
              ...
              <div class="col-sm-0 col-md-0 sidebar" style="position: relative;left: 950px;bottom:7px">
                ...
                <div class="btn-group" role="group" >
                        ...
                        <li><a href="orc.php?jorc=<?php echo $tampung['genre'] ?>"><?php echo $tampung['genre'] ?></a></li>
                      <?php endwhile ;?>
