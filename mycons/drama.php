...
$dataperhalaman=6;
$total= mysqli_query($con,"select * from produk where  kategori_id='k2'");
...
if(isset($_GET["jenis"])){
    ...
    from (select *from produk where kategori_id='k2') a,kursi b
    ...
    <nav
        ...
        <ul>
            ...
            <li style="float: right;" class="lihover"><a href="login.php"
                    style="margin-top: 20px;text-decoration: none;" class="ahover"><?php echo $_SESSION["nama"]?></a>
            </li>
...
_________________________________________________________ -->
                ...
                <div class="pages">
                    ...
                    <ul class="pagination">
                      ...
                      for($i=1; $i<=$jumlahhalaman;$i++) :  ?>
                        ...
                        <li class="active"><a style="background-color:red"
                                href="?jenis=<?=$_GET["jenis"];?>&page=<?=$i; ?>"><?= $i; ?></a>
                            <?php else : ?>
    ...
    <script src="scriptdrama.js"></script>
</body>
