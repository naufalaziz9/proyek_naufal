...
<BODY>
  ...
  <div class="container">
    ...
    <form class="form-signin" method="post" action="recive.php">
      ...
      <button class="btn btn-lg btn-primary btn-block" style="background-color:#337ab7" type="submit" name="login">Sign
        in</button>
