...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Bulan Mei 2020 pada 12.26
...
('c208', 'u002', 0, '7341r39npnjkt4793f5b53n1ti'),
('c209', 'u000', 230000, 'naufalaziz78@gmail.com'),
('c21', 'u000', 20000, 'g1hp8tisjfh953ino4nhjiiie4'),
('c210', 'u000', 20000, 'jh6343fcuof4rs2j7c551nbk2l'),
('c211', 'u000', 44000, 'naufalaziz78@gmail.com'),
...
CREATE TABLE `contact` (
  `contact_id` varchar(6) CHARACTER SET latin1 NOT NULL,
...
INSERT INTO `contact` (`contact_id`, `user_id`, `email`, `nama_depan`, `nama_belakang`, `subyek`, `pesan`) VALUES
('con1', 'u003', 'bevankevin0@gmail.com', 'BE VAN CHRISTIAN', 'BE VAN CHRISTIAN', 'kualitas', 'tidak ada fitur khusus'),
('con10', 'u007', 'aziz@gmail.com', 'aziz', 'imad', 'tahapan', 'tahapannya tidak sesuai'),
('con2', 'u004', 'bevankevin0@gmail.com', 'BE VAN CHRISTIAN', 'BE VAN CHRISTIAN', 'harga', 'mengapa jarang ada promo-promo?'),
('con3', 'u001', 'dim@gmail.com', 'dimmy', 'putra', 'pembayaran', 'saya sarankan terdapat fitur refund'),
('con4', 'u005', 'naufal@gmail.com', 'naufal', 'imaduddin', 'tampilan', 'Kenapa tampilannya tidak sesuai dengan konsep bisnisnya'),
('con5', 'u002', 'zacky@gmail.com', 'zacky', 'amar', 'sistem', 'step step nya terlalu panjang'),
('con6', 'u006', 'daraldrlh2@gmail.com', 'Daral', 'Brittany', 'cakupan acara', 'ada acara yg seru di luar sana, tetapi tidak tersedia di sini. Ini mengecewakan'),
('con8', 'u008', '', '', '', '', ''),
('con9', 'u000', '', '', '', '', '');
...
('pb100', 'c187', 'jp8', 's1', '2019-12-06'),
('pb101', 'c188', 'jp8', 's4', '2019-12-06'),
('pb102', 'c189', 'jp8', 's4', '2019-12-06'),
('pb103', 'c190', 'jp2', 's1', '2019-12-06'),
('pb104', 'c191', 'jp8', 's1', '2019-12-06'),
...
('pb83', 'c170', 'jp8', 's1', '2019-12-06'),
('pb84', 'c171', 'jp1', 's1', '2019-12-06'),
('pb85', 'c172', 'jp8', 's1', '2019-12-06'),
('pb86', 'c173', 'jp1', 's1', '2019-12-06'),
('pb87', 'c174', 'jp7', 's1', '2019-12-06'),
('pb88', 'c175', 'jp2', 's1', '2019-12-06'),
('pb89', 'c176', 'jp8', 's1', '2019-12-06'),
('pb9', 'c27', 'jp7', 's1', '2019-11-24'),
('pb90', 'c177', 'jp8', 's1', '2019-12-06'),
('pb91', 'c178', 'jp8', 's4', '2019-12-06'),
('pb92', 'c179', 'jp8', 's4', '2019-12-06'),
('pb93', 'c180', 'jp8', 's1', '2019-12-06'),
('pb94', 'c181', 'jp2', 's1', '2019-12-06'),
('pb95', 'c182', 'jp8', 's1', '2019-12-06'),
('pb96', 'c183', 'jp8', 's1', '2019-12-06'),
('pb97', 'c184', 'jp8', 's4', '2019-12-06'),
('pb98', 'c185', 'jp8', 's4', '2019-12-06'),
('pb99', 'c186', 'jp8', 's1', '2019-12-06');
...
('u000', 'non-member', '-', '-', '0', '-', 'm2'),
('u001', 'bevankevin', 'bevankevin0@gmail.com', '123', '08123789090', 'Jl. Raya Sambikerep, Lontar', 'm1'),
('u002', 'zacky', 'zacky@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '08159287832', 'Citraland Bukit Golf Utama', 'm1'),
('u003', 'james', 'james@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '08145369878', 'Jl. Raya Darmo', 'm1'),
('u004', 'priscil', 'priscil@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '08823864773', 'jl. made sabara kendari', 'm1'),
('u005', 'adimas', 'adimas@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '08128723873', 'Jl. Manukan Peni I', 'm1'),
('u006', 'admin', 'admin@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '08176276374', 'Citraland Bukit Golf Internasional', 'm1'),
('u007', 'christie', 'bchristian01@student.ciputra.ac.id', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '08172367263', 'Pakuwon Indah', 'm1'),
('u008', 'alamsyah1810', 'alamsyahfsxpilot@gmail.com', 'be6d2d1e19b97135d12bc206c694d6f9536119ef', '08176372375', 'Graha Family', 'm1');
...
ALTER TABLE `cart_produk`
  ...
  ADD KEY `FK_cart_produk_3` (`kursi_id`);
...
ALTER TABLE `pembayaran`
  ...
  ADD KEY `FK_pembayaran_2` (`jenis_pembayaran_id`),
  ADD KEY `FK_pembayaran_3` (`status_id`);
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `FK_cart_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);

--
-- Ketidakleluasaan untuk tabel `cart_produk`
--
ALTER TABLE `cart_produk`
  ADD CONSTRAINT `FK_cart_produk_1` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`cart_id`),
  ADD CONSTRAINT `FK_cart_produk_2` FOREIGN KEY (`produk_id`) REFERENCES `produk` (`produk_id`),
  ADD CONSTRAINT `FK_cart_produk_3` FOREIGN KEY (`kursi_id`) REFERENCES `kursi` (`kursi_id`);

--
-- Ketidakleluasaan untuk tabel `contact`
--
ALTER TABLE `contact`
  ADD CONSTRAINT `FK_contact_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
...
ALTER TABLE `pembayaran`
  ...
  ADD CONSTRAINT `FK_pembayaran_2` FOREIGN KEY (`jenis_pembayaran_id`) REFERENCES `jenis_pembayaran` (`jenis_pembayaran_id`),
  ADD CONSTRAINT `FK_pembayaran_3` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`);
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `FK_user_1` FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`);
COMMIT;
