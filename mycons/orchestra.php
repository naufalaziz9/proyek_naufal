...
$dataperhalaman=6;
$total= mysqli_query($con,"select * from produk where  kategori_id='k3'");
$total2= mysqli_num_rows($total);
$jumlahhalaman=ceil($total2/$dataperhalaman);
if(isset($_GET["page"])){
    $halamanaktif=$_GET["page"];
}else{
    $halamanaktif=1;
}
// perhalaman 2 aku di page 2 awalnya 2
// perhalaman 2 aku di page 3 awalnya 4
//perhalaman 2 aku di page 4 awalnya 6
$awaldata=($halamanaktif*$dataperhalaman)-$dataperhalaman;
if( isset($_GET["jenis"])){
    $query = mysqli_query($con,"select a.nama_produk,a.gambar,min(b.harga)
    from (select *from produk where kategori_id='k3') a,kursi b
...
<body>
    ...
    <nav
        ...
        <li><img src="assets/images/manok.png" style='height:80px;width:192px;margin-top:17px;margin-left:10px;'
            ...
            <li class="lihover"><a href="drama.php" style="margin-top: 20px;text-decoration:none;" class='ahover'>Theatrical</a>
            <li class="lihover"><a href="orchestra.php" style="margin-top: 20px;text-decoration:none;" class='ahover'>Orchestra </a>
            ...
            <li style="margin-top:32px;margin-left: 20px;">
                <input type="search" class="lisearch" placeholder="search" required="" 
                    style="width: 450px;float: right;"id="searchbar">
            </li>
   ...
   <li style="float: right;" class="lihover"><a href="login.php" style="margin-top: 20px;text-decoration: none;" class="ahover"><?php echo $_SESSION["nama"]?></a></li>
    ...
    <div id="aa" class="col-md-12" style='top:150px;'>
        <div class="col-sm-2">
...
_________________________________________________________ -->
                ...
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked category-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="orchestra.php?jenis=symphony">Symphony</a>
                                </li>
    ...
    <footer id="footer" class="col-md-12" style="margin-top:-50px;">
        <div class="container">
    ...
    <script src="scriptorchestra.js"></script>
</body>
